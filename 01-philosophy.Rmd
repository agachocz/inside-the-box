...
I - Ci, którzy uważają, że jest faktyczną właściwością świata rzeczywistego. Uważają oni, że świat "działa" według wzorów matematycznych. Można nawet spotkać się z określeniami, że matematyka jest językiem Boga lub językiem Natury - a więc że była wzorcem, według którego wszystko powstało.
